...
#
# A module for users to play audio from YouTube, SoundCloud,and local audio files.
# Features queueing, vote skipping, configurable cache size, playlists, and more.
#
